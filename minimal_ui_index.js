...
async function downloadAndFlash() {
    ...
    try {
        const flashOptions = {
            ...
            flashMode: undefined,
            flashFreq: undefined,
            eraseAll: false, // Always erasing before flash
            compress: true,
        };
...
connectButton.onclick = async () => {
    try {
        ...
        if (chipDesc !== "default") {
            ...
            console.log("Connected to device with chip: " + chipDesc)
